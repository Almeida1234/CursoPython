...
#     primeira_letra = opcao[0]
    
#     if primeira_letra == 'l':# or opcao =='listar':
#         os.system('clear')
#         # if len(lista) == 0: Código professor
#         if lista == []:
...
#     elif opcao == 'i' or opcao =='inserir':
#         os.system('clear')
#         inserir = input('O que deseja adicionar: ')
